...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %><!-- 천단위 , 해주는 거 -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
<jsp:include page="top.jsp" /> <!-- 머릿글 바닥글 고정할 때 사용(include) -->
<hr>
	<table>
		<thead>
			<tr bgcolor="#dedede">
					...
					<c:forEach var="k" items="${shop_list}">
						<tr>
							...
							<td>할인가 : <fmt:formatNumber value="${k.p_saleprice}" pattern="#,##0" />원
								<br><font color="red" size="2px;">(할인률 : ${k.getPercent()}%)</font></td>
