...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<table summary="게시판 수정">
			<caption><h3>Board 게시판 수정</h3></caption>
		<tbody>
			<tr>
				<th>작성자</th>
				<td align="left"><input type="text" name="writer" value="${bov.writer}" ></td>
			</tr>
			<tr>
				<th>제목</th>
				<td align="left"> <input type="text" name="title" value="${bov.title}" ></td>
			</tr>
			<tr>
				<th>내용</th>
				<td align="left"><textarea rows="10" cols="60" name="content">${bov.content}</textarea>
				</td>
			</tr>
			<tr>
				<th>첨부파일</th>
