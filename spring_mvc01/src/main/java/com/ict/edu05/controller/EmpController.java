...
public class EmpController {
	...
	public ModelAndView emp_form() {
		return new ModelAndView("day05/emp_form"); //ModelAndView로 인해 jsp이동
	}
	...
	/*
	  @PostMapping("/emp_dynamic_search") public ModelAndView
	  emp_dynamic_search(EmpVO empvo) { try { ModelAndView mv = new
	  ModelAndView("day05/emp_dynamic"); List<EmpVO> list =
	  empService.getSearch(empvo); mv.addObject("list", list); mv.addObject("idx",
	  empvo.getIdx()); return mv; } catch (Exception e) { System.out.println(e);
	  return null; } }
	 */
