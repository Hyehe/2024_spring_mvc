...
// Controller는 servlet-context.xml로 리턴한다.
// RestController는 servlet-context.xml로 리턴하지 않고 브라우저에 출력
...
// method 만들기
	...
	@ResponseBody
	// 반환형이 String인 경우 문서 타입이 contentType="text/html"로 변경시키자.
	...
	public String Xml_Exam01() {
		...
		sb.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>"); // java의 쌍따옴표 표현(xml) => \"
		sb.append("<products>");
	...
	public String Xml_Exam02() {
		...
		try {
			...
			br = new BufferedReader(new InputStreamReader(conn.getInputStream())); // 사이트에 접속해서 끌어올 수 있는 상태를 만들어줌
	...
	public String Xml_Exam03() {
		...
		try {
			...
			urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8")
					+ "=mGOouLK5nCuSX2cGF3PVbjnacpFwXl4LM0NHvsB5J0xdhIBSh7Vwq1UQMpE5AEgArarVo/rL5U4sDM4fcRpoKA=="); /* 자기의 서비스키 = Service Key(디코딩을 복붙)*/
			...
			// conn.setRequestProperty("Content-type", "application/json"); json할 때만 주석해제해주기
			System.out.println("Response code: " + conn.getResponseCode()); // 200 _ OK
	...
	public String Json_Exam07() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8")
	        	+ "=mGOouLK5nCuSX2cGF3PVbjnacpFwXl4LM0NHvsB5J0xdhIBSh7Vwq1UQMpE5AEgArarVo/rL5U4sDM4fcRpoKA=="); /*Service Key*/
